...
namespace CenterApp.Infrasturcture.Migrations
{
    ...
    [Migration("20220825162732_addstageintoGroup")]
    partial class addstageintoGroup
    {
            ...
            modelBuilder.Entity("CenterApp.Core.Models.Student", b =>
                {
                    ...
                    b.Property<DateTime>("Student_RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 25, 18, 27, 32, 86, DateTimeKind.Local).AddTicks(9927));
